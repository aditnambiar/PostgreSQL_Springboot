...
public class CustomerDaoImpl implements CustomerDao{
	...
	public void updateContactInfo(int id, String firstName, String lastName, String dateOfBirth, String email, int phoneNumber) {
		...
		dataBaseConnection.update(sql, firstName, lastName, dateOfBirth, email, phoneNumber, id);
	...
	public void updateAddress(int id, String addressline1, String addressline2, String city, String state, int zipcode) {
		...
		dataBaseConnection.update(sql, addressline1, addressline2, city, state, zipcode, id);
	...
	public List<Customer> returnCustomers() {
        ...
        List<Map<String, Object>> rows_1 = dataBaseConnection.queryForList(sql_1);
        List<Map<String, Object>> rows_2 = dataBaseConnection.queryForList(sql_2);
	...
	public String findNameByID(int id) {
		...
		String firstName = dataBaseConnection.queryForObject(sql_1, new Object[]{id}, String.class);
		String sql_2 = "SELECT lastname FROM contactinfo WHERE id = ?";
		String lastName = dataBaseConnection.queryForObject(sql_2, new Object[]{id}, String.class);
	...
	public ContactInfo findContactInfoByID(int id) {
		String sql = "SELECT * FROM contactinfo WHERE id = ?";
	      return (ContactInfo)dataBaseConnection.queryForObject(sql, new Object[]{id}, new RowMapper<ContactInfo>(){
	        @Override
	...
	public Address findAddressByID(int id) {
		...
		return (Address)dataBaseConnection.queryForObject(sql, new Object[]{id}, new RowMapper<Address>(){
	        @Override
	...
	public int returnCount() {
		...
		return dataBaseConnection.queryForObject(sql, Integer.class);
